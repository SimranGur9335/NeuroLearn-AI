                            ...
                            <div>
                              <div className="flex justify-between items-start mb-3">
                                <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-full ${
                                  role.difficulty === "Beginner" ? 'bg-blue-100 text-blue-700 dark:bg-blue-950/40 dark:text-blue-450' :
                      ...
                      <div className="space-y-2">
                        {aiAnalysis.mock_interview_questions.map((q, idx) => (
                          <div
                            ...
                            className={`p-3 rounded-xl border cursor-pointer text-xs transition-all flex items-center justify-between group ${
